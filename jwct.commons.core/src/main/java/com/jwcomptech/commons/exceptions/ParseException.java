...
public class ParseException extends RuntimeException {
    ...
    public ParseException(@NotNull final Class<?> type, final String attemptedValue) {
        super(buildMessage(type, attemptedValue));
    }
    ...
    public static @NotNull String buildMessage(final @NotNull Class<?> type,
                                               final String attemptedValue) {
        return "Failed to parse %s [%s]".formatted(type, attemptedValue);
    }
}
