...
import com.jwcomptech.shared.enums.DLStatus;
...
import static com.jwcomptech.shared.enums.DLStatus.*;
import static com.jwcomptech.shared.utils.CheckIf.isBoolean;

public class Downloader extends Observable implements AutoCloseable, Runnable {
    ...
    public Downloader(final String url) throws MalformedURLException {
    ...
    public Downloader(final String path, final String url) throws MalformedURLException {
        this(path, URI.create(url).toURL());
    }

    // Constructor for Download.
    public Downloader(final String path, final URL url) {
        this.path = path;
