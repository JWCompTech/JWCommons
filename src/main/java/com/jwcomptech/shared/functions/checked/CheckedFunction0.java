...
import com.jwcomptech.shared.functions.Function0;
import com.jwcomptech.shared.functions.Lazy;
import com.jwcomptech.shared.functions.Memoized;
import com.jwcomptech.shared.functions.tuples.Tuple0;
...
public interface CheckedFunction0<R> extends Serializable {
     ...
     */
    @Contract(pure = true)
    static <R> @NotNull CheckedFunction0<R> constant(R value) {
        return () -> value;
    }
     ...
     */
    @Contract(pure = true)
    static <R> @NotNull Function0<Option<R>> lift(CheckedFunction0<? extends R> partialFunction) {
     ...
     */
    @Contract(pure = true)
    static <R> @NotNull Function0<Try<R>> liftTry(CheckedFunction0<? extends R> partialFunction) {
