...
//            }
    ...
    public static final class Version {
         ...
         */
        public static com.jwcomptech.shared.info.Version get() {
            return versionObj;
        }
        ...
        @Contract(" -> new")
        private static com.jwcomptech.shared.info.@NotNull Version getVersionInfo() throws IOException, InterruptedException {
            ...
            return new com.jwcomptech.shared.info.Version(
                    VersionString,
                    Major.toInteger(),
                    Minor.toInteger(),
                    Build.toInteger(),
     ...
     */
        ...
        public record InstallInfoObject(StringValue activationStatus,
                                        ...
                                        com.jwcomptech.shared.info.Version version) { }
