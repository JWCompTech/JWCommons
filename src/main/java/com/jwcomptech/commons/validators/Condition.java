...
public final class Condition {
    ...
    /**
     * The message that can be displayed if the condition evaluates to a failure.
     */
    ...
    public static Condition TRUE = new Condition(
            () -> true, "Always evaluates to true!", true)
            .evaluate();
    ...
    public static Condition FALSE = new Condition(
            () -> false, "Always evaluates to false!", true)
            .evaluate();
    ...
    /**
     * Creates a new Condition instance with the specified evaluation and failure message.
     *
     * @param evaluation a boolean supplier that provides the evaluation condition
     * @param failureMessage the message that can be displayed if the condition evaluates to false
     * @return a new Condition instance
     */
    public static @NotNull Condition of(final Supplier<Boolean> evaluation,
                                        final String failureMessage) {
        return new Condition(evaluation, failureMessage);
    }
    ...
    private Condition(final Supplier<Boolean> evaluation, final String failureMessage) {
        this(evaluation, failureMessage, false);
    }
     ...
     * To reevaluate call {@link Condition#reevaluate()} instead.
     *
    ...
    public Condition reevaluate() {
        checkArgumentNotNull(evaluation, cannotBeNull("evaluation"));
        if(evaluated && immutable) return this;
