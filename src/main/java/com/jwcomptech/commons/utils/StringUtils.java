...
public final class StringUtils {
    ...
    /**
     * Checks input if it is null or empty and if either is true returns
     * fallback, otherwise returns the input.
     *
     * @param input the string to check
     * @param fallback the fallback string
     * @return input if not null or empty, otherwise fallback
     */
    public static String fallbackIfBlank(String input, String fallback) {
